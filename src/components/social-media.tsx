      ...
      <ul className="mb-32">
        <li className="flex ">
          ...
          >
            ...
            <span className="ml-4 text-zinc-400">Follow on Twitter/X</span>
          </a>
        </li>
        <li className="mt-4 flex">
          <a
            className="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-600 dark:text-zinc-200 dark:hover:text-teal-400"
            href="https://instagram.com/argretya"
          >
            <svg
              viewBox="0 0 24 24"
              aria-hidden="true"
            ...
            <span className="ml-4 text-zinc-400">Follow on Instagram</span>
          </a>
        </li>
        <li className="mt-4 flex">
          <a
          ...
          >
            ...
            <span className="ml-4 text-zinc-400">Follow on GitHub</span>
          </a>
        </li>
        <li className="mt-4 flex">
          <a
          ...
          >
            ...
            <span className="ml-4 text-zinc-400">Follow on LinkedIn</span>
          </a>
        </li>
